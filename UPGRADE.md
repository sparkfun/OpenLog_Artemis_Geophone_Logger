...
* OpenLog_Artemis_Geophone_Logger-X04-v10.bin - is the _stable_ version for the **X04 SparkX (Black) OLA**
* OpenLog_Artemis_Geophone_Logger-X04-v11_BETA.bin - is a _beta_ version for the **X04 SparkX (Black) OLA** containing new features and improvements

## To use:

* Download and extract the [Geophone Logger repo ZIP](https://github.com/sparkfun/OpenLog_Artemis_Geophone_Logger/archive/master.zip)
